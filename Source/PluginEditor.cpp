    ...
    : AudioProcessorEditor (ownerFilter)
{
    ...
    addAndMakeVisible (panInfoLabel = new Label ("new label",
                                                 TRANS("C")));
    panInfoLabel->setTooltip (CharPointer_UTF8 ("\xc5\xa1"));
    ...
    addAndMakeVisible (label = new Label ("new label",
                                          ...
                                          "label text\n"
                                          "label text")));
    label->setFont (Font ("Aharoni", 15.00f, Font::plain));
...
void JuceDemoPluginAudioProcessorEditor::resized()
{
    ...
    midSideSlider->setBounds (20, 165, 60, 60);
    ...
    reverbSizeSlider->setBounds (312, 168, 50, 50);
    midsideInfoLabel->setBounds (10, 220, 80, 30);
    reverbSizeHeader->setBounds (298, 149, 80, 30);
    label->setBounds (88, 216, 144, 104);
...
void JuceDemoPluginAudioProcessorEditor::sliderValueChanged (Slider* sliderThatWasMoved)
{
    ...
    else if (sliderThatWasMoved == reverbSizeSlider)
    {
		...
		getProcessor()->setParameterNotifyingHost(JuceDemoPluginAudioProcessor::reverbSizeParam,
...
<JUCER_COMPONENT documentType="Component" className="JuceDemoPluginAudioProcessorEditor"
  ...
  <LABEL name="new label" id="b192efc88f0f8308" memberName="delayHeader"
         ...
         edTextCol="ff000000" edBkgCol="0" labelText="delay amount" editableSingleClick="0"
  ...
  <LABEL name="new label" id="64ddab567eb77e3c" memberName="panInfoLabel"
         virtualName="" explicitFocusOrder="0" pos="110 110 80 30" tooltip="&#353;"
         textCol="ff282828" edTextCol="ff000000" edBkgCol="0" labelText="C"
  ...
  <SLIDER name="mid/side slider" id="84706171dc5b90dd" memberName="midSideSlider"
          virtualName="" explicitFocusOrder="0" pos="20 165 60 60" min="0"
  ...
  <SLIDER name="new slider" id="81b8a5f3e2f90d2e" memberName="reverbSizeSlider"
          virtualName="" explicitFocusOrder="0" pos="312 168 50 50" min="0.01"
          max="1" int="0" style="RotaryVerticalDrag" textBoxPos="NoTextBox"
          textBoxEditable="1" textBoxWidth="80" textBoxHeight="20" skewFactor="1"/>
  <LABEL name="new label" id="63580ead55c45fe" memberName="midsideInfoLabel"
         virtualName="" explicitFocusOrder="0" pos="10 220 80 30" textCol="ff363636"
         edTextCol="ff000000" edBkgCol="0" labelText="80%" editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Aharoni"
         fontsize="15" bold="0" italic="0" justification="36"/>
  <LABEL name="new label" id="9e5a6f98ed1157ee" memberName="reverbSizeHeader"
         virtualName="" explicitFocusOrder="0" pos="298 149 80 30" textCol="ff363636"
         edTextCol="ff000000" edBkgCol="0" labelText="room size" editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Aharoni"
         fontsize="10" bold="0" italic="0" justification="36"/>
  <LABEL name="new label" id="80913a9abd9c31a1" memberName="label" virtualName=""
         explicitFocusOrder="0" pos="88 216 144 104" edTextCol="ff000000"
         edBkgCol="0" labelText="label text&#10;label text&#10;label text&#10;label text"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Aharoni" fontsize="15" bold="0" italic="0" justification="33"/>
</JUCER_COMPONENT>
